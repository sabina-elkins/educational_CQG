...
Repository for the paper titled as above, published in AIEd 2023 in the Late Breaking Results track.
Read the paper here: https://arxiv.org/pdf/2304.06638.pdf
...
## Project Abstract
Controllable text generation (CTG) by large language models (LLMs) has a huge potential to transform education for teachers and students alike. Specifically, high quality and diverse question generation (QG) can dramatically reduce the load on teachers and improve the quality of their educational content. Recent work in this domain has made progress with generation, but fails to show that real teachers judge the generated questions as sufficiently useful for the classroom setting; or if instead the questions have errors and/or pedagogically unhelpful content. We conduct a human evaluation with teachers to assess the quality and usefulness of outputs from combining CTG and question taxonomies (Bloom’s taxonomy and a difficulty taxonomy). The results demonstrate that the questions generated are high quality and sufficiently useful, showing their promise for widespread use in the classroom setting.

## Citing this Work
This will be updated when the work is up on arXiv with a link to the paper and the citation for it.
...
```
Generate {control_element} questions.
...
![Race or Ethnicity](images/race.jpg)
![Educational Level](images/edu.jpg)
![Educational Discipline](images/edu_field.jpg)
...
| Question Taxonomy | n | Relevance (avg) | Relevance (std) | Grammar (avg) | Grammar (std) | Adherence (avg) | Adherence (std) | Answerable (avg) | Answerable (std) | Useful (avg) | Useful (std) |
|---|---|---|---|---|---|---|---|---|---|---|---|
| all candidates | 30 | 0.9667 | 0.1798 | 0.9568 | 0.2040 | 0.6741 | 0.4696 | 0.9136 | 0.2819 | 3.7667 | 0.3880 |
| remembering | 30 | 0.9667 | 0.1826 | 1.0000 | 0.0000 | 0.8333 | 0.3790 | 1.0000 | 0.0000 | 3.5500 | 0.6208 |
| understanding | 30 | 1.0000 | 0.0000 | 0.8889 | 0.3234 | 0.8000 | 0.4068 | 0.8333 | 0.3835 | 3.6500 | 0.5746 |
| applying | 30 | 0.9667 | 0.1826 | 1.0000 | 0.0000 | 0.6667 | 0.4795 | 0.8889 | 0.3234 | 3.2667 | 0.8584 |
| analyzing | 30 | 0.9667 | 0.1826 | 0.8889 | 0.3234 | 0.7333 | 0.4498 | 0.8333 | 0.3835 | 3.4000 | 0.8030 |
| evaluating | 30 | 0.9333 | 0.2537 | 1.0000 | 0.0000 | 0.5333 | 0.5074 | 0.8333 | 0.3835 | 3.5667 | 0.5371 |
| creating | 30 | 0.9333 | 0.2537 | 1.0000 | 0.0000 | 0.4000 | 0.4983 | 1.0000 | 0.0000 | 3.7333 | 0.5683 |
| beginner | 30 | 1.0000 | 0.0000 | 0.9444 | 0.2357 | 0.6333 | 0.4901 | 0.9444 | 0.2357 | 3.6333 | 0.5403 |
| intermediate | 30 | 0.9667 | 0.1826 | 0.9444 | 0.2357 | 0.6667 | 0.4795 | 1.0000 | 0.0000 | 3.0167 | 0.7250 |
| advanced | 30 | 0.9667 | 0.1826 | 0.9444 | 0.2357 | 0.8000 | 0.4068 | 0.8889 | 0.3234 | 3.2639 | 0.8659 |
